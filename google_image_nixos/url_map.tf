...
variable "url_map" {
  ...
  default = {
    ...
    "20.09"  = "https://nixos-cloud-images.storage.googleapis.com/nixos-image-21.03.git.6bf223c82e0-x86_64-linux.raw.tar.gz"
    "latest" = "https://nixos-cloud-images.storage.googleapis.com/nixos-image-21.03.git.6bf223c82e0-x86_64-linux.raw.tar.gz"
  }
